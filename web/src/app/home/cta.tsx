      ...
      <div className="container max-w-4xl text-center">
        <div className="group relative isolate overflow-hidden rounded-3xl bg-linear-to-br from-cyan-500 via-blue-600 to-blue-700 p-0.5 transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl hover:shadow-blue-500/50">
          <div className="relative overflow-hidden rounded-3xl bg-linear-to-br from-cyan-500 via-blue-600 to-blue-700 px-8 py-16 sm:px-16 sm:py-24">
            <div className="absolute inset-0 bg-[linear-gradient(to_right,#ffffff08_1px,transparent_1px),linear-gradient(to_bottom,#ffffff08_1px,transparent_1px)] mask-[radial-gradient(ellipse_80%_50%_at_50%_50%,#000_70%,transparent_110%)] bg-size-[24px_24px]" />
            ...
            <div className="relative z-10 flex flex-col items-center gap-8">
              ...
              <div className="flex flex-col items-center gap-4">
                ...
                <p className="max-w-2xl text-lg leading-relaxed text-pretty text-cyan-50/90 sm:text-xl">
              ...
              {isSignedIn ? (
                ...
                >
                  <Link href="/dashboard" className="flex items-center gap-2">
                    ...
                    <MoveRight />
                    <div className="absolute inset-0 -z-10 bg-linear-to-r from-cyan-100 to-blue-100 opacity-0 transition-opacity duration-300 group-hover/btn:opacity-100" />
                  </Link>
                </Button>
              ) : (
            ...
            <div className="absolute inset-0 -top-full h-full w-full bg-linear-to-b from-transparent via-white/10 to-transparent opacity-0 transition-all duration-1000 group-hover:top-full group-hover:opacity-100" />
          </div>
        </div>
      </div>
    </section>
