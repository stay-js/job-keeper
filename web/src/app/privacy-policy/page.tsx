    ...
    <div className="flex flex-col gap-10">
      ...
      <section className="flex flex-col gap-4">
        ...
        <p className="leading-relaxed text-neutral-100">
          ...
          an account, use our services, or interact with our website. This information is primarily
          used to provide and improve the functionality of the Job Keeper application.
        </p>
        <h3 className="text-xl font-medium">Information collected includes:</h3>
        <ul className="flex list-inside list-disc flex-col gap-1">
          <li className="leading-relaxed text-neutral-100">
            <strong>User ID:</strong> A unique identifier associated with your account, provided by
            our authentication service (Clerk), and used to link your data within the application.
          </li>
          <li className="leading-relaxed text-neutral-100">
      ...
      <section className="flex flex-col gap-4">
        ...
        <ul className="flex list-inside list-disc flex-col gap-1">
          <li className="leading-relaxed text-neutral-100">
            ...
            application data directly within the Job Keeper application. For information managed by
            Clerk, you can usually access and manage it through your Clerk account settings.
          </li>
          <li className="leading-relaxed text-neutral-100">
      ...
      <section className="flex flex-col gap-4">
        ...
        <p className="leading-relaxed text-neutral-100">
          ...
          for other operational, legal, or regulatory reasons. The “Last Updated” date at the top
          will indicate when the policy was last revised. We encourage you to review this policy
          periodically.
        </p>
      </section>
